import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-4X7A4XC5.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-RQL2C4K2.js";
import {
  LimitsModal
} from "./chunk-DU5MH2QB.js";
import {
...
} from "./chunk-CBDYDTPQ.js";
import {
  useTypedSelector
} from "./chunk-G6LKXNHA.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-QT7DBXB6.js";
import {
  useConfig,
  useTracking
} from "./chunk-QRSTXUXB.js";
import {
  AssetSource,
  AssetType,
...
import {
  renderAdmin
} from "./chunk-RA3O2QCJ.js";
import {
  useAIAvailability
} from "./chunk-JYF67TFI.js";
import {
  useLicenseLimits
} from "./chunk-X7LRJHOU.js";
import {
  Table,
  useTable
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-2CI3HV5O.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-MWYGJBAM.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-UKACFYHK.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-K2FUOTEQ.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-B2AEJVHH.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-S64DSCJ6.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-K457HHUA.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-MYPZF4ZE.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-OYBRTDDS.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-3FYT4BXE.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-X6IW4CVV.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-HDEX3UTP.js");
          return {
...
//# sourceMappingURL=chunk-MSZONLWA.js.map
